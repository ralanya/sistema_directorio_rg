                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php if($id_rol == 1 || $id_rol == 2){ ?>
                                    <button class="btn btn-primary mb-2" type="button" onclick="frmPersonal();">Nuevo <i class="fas fa-plus"></i></button>
                                <?php }else{}?> 
                                <button class="btn btn-danger mb-2" type="button" onclick="generarPDFPersonal();">Generar PDF <i class="far fa-file-pdf"></i></button>                                                    
                                <table id="tblPersonales" class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <div id="nuevo_personal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary">
                                                <h5 class="modal-title text-white" id="title"></h5>
                                                <button class="close" onclick="cerrar_personal(event);">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Institucional</a>
                                                    </li>
                                                    <li class="nav-item">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="tab-pane fade mt-2" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                        <div class="row">                                                        
                                                            <div class="col md 6">
                                                                <div class="form-group">
                                                                    <label for="cbocargo">Cargo <span style="color:red">(*)</span></label>
                                                                    <select id="cbocargo" class="form-control" name="cbocargo">
                                                                    <option value="NA">Seleccione una opción</option>
                                                            ...
                                                            <div class="col md 6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="txtespecialidad" class="form-control" type="text" name="txtespecialidad" placeholder="Especialidad" maxlength="50" onkeypress="return sololetras(event);">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <span style="color:red; font-size:0.8em;">Campos obligatorios (*)</span> 
                                                ...
                                                <!-- FIN TABS -->                                             
                                                    <button class="btn btn-primary" type="button" onclick="registrarPers(event);" id="btnAccion">Guardar</button>
                                                    <button class="btn btn-danger" type="button" onclick="cerrar_personal(event);">Cancelar</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
